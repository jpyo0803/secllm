...
class DynamicCache(Cache):
    ...
    def update_key(
        ...
        """
        Updates the cache with the new `key_states` for the layer `layer_idx`.
    ...
    def update_value(
        ...
        """
        Updates the cache with the new `value_states` for the layer `layer_idx`.
        ...
        # content on layer cache can be a tensor and checking not tensor causes errors
        # so we explicitly check for the empty list
        elif self.value_cache[layer_idx] == []:
