...
class SqLlamaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # Temporary barrier to wait for the tasks to finish, Fix it
        while True:
            if secllm_cpp_wrapper.BookKeeperIsAvailable_Float(self.layer_idx, 98, 0) and secllm_cpp_wrapper.BookKeeperIsAvailable_Float(self.layer_idx, 98, 1):
                break
